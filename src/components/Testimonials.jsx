...
const Testimonials = () => {
  ...
  const testimonials = [
    { name: 'Sarah Johnson', role: 'CEO, TechVault Inc.', text: 'Asalkar Techworks transformed our outdated website into a stunning e-commerce platform. Our sales increased by 300% within the first quarter. Absolutely phenomenal team!', rating: 5, initials: 'SJ', color: '#FF6B35' },
    ...
    { name: 'Emily Rodriguez', role: 'Marketing Director, FitPro', text: 'Working with Asalkar Techworks was an absolute pleasure. They understood our vision perfectly and delivered a web application that exceeded all expectations.', rating: 5, initials: 'ER', color: '#28A745' },
